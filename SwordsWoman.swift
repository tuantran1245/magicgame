...
import SpriteKit
class SwordsWoman: SKSpriteNode, Creep, Enemy {
    let screenSize = UIScreen.main.bounds
    var textureAtlas:SKTextureAtlas =
        SKTextureAtlas(named:"SwordsWoman")
    ...
    func spawn(parentNode:SKNode, position: CGPoint,
        ...
        self.zPosition = 5
        self.alpha = 0
        self.texture = self.textureAtlas.textureNamed("1_WOMAN_IDLE_000.png")
    ...
    func createAnimation() {
        ...
        for index in 0...4 {
            runSequence.append(textureAtlas.textureNamed("3_WOMAN_RUN_00\(index).png"))
        }
        ...
        for index in 0...4 {
            attackSequence.append(textureAtlas.textureNamed("5_WOMAN_ATTACK_00\(index).png"))
        }
        ...
        for index in 0...4 {
            damageSequence.append(textureAtlas.textureNamed("6_WOMAN_HURT_00\(index).png"))
        }
        ...
        for index in 0...4 {
            dieSequence.append(textureAtlas.textureNamed("7_WOMAN_DIE_00\(index).png"))
        }
