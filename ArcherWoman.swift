...
import SpriteKit
class ArcherWoman: SKSpriteNode, Ranger, Creep, Enemy {
    let screenSize = UIScreen.main.bounds
    var textureAtlas:SKTextureAtlas =
        SKTextureAtlas(named:"ArcherWoman")
    ...
    func spawn(parentNode:SKNode, position: CGPoint,
        ...
        self.name = "WomanArcher"
        self.size = size
        self.position = position
        self.zPosition = 5
        self.alpha = 0
        self.texture = self.textureAtlas.textureNamed("1_ARCHERWOMAN_IDLE_000.png")
    ...
    func createAnimation() {
        ...
        for index in 0...4 {
            runSequence.append(textureAtlas.textureNamed("3_ARCHERWOMAN_RUN_00\(index).png"))
        }
        ...
        for index in 0...4 {
            attackSequence.append(textureAtlas.textureNamed("5_ARCHERWOMAN_ATTACK_00\(index).png"))
        }
        ...
        for index in 0...4 {
            damageSequence.append(textureAtlas.textureNamed("6_ARCHERWOMAN_HURT_00\(index).png"))
        }
        ...
        for index in 0...4 {
            dieSequence.append(textureAtlas.textureNamed("7_ARCHERWOMAN_DIE_00\(index).png"))
        }
